...
<head>
	...
	<!-- Script for the login validation -->
	<!-- Script -->
...
<body>
	...
	<div class="row">
            <div class="box">
                <div class="col-lg-12">
				<!-- this is for creating an alert message to the users to log in -->
				<div class="alert alert-danger">
				   <strong>You must be logged in to view the blog</strong>
					...
					<div class="form-group col-lg-12">
					<!-- this is for creating a button for new mwbers in the log in page -->
